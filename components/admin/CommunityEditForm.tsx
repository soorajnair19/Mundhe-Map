...
const fieldClass =
  "mt-1 w-full rounded-md border border-[var(--border)] bg-[var(--panel)] px-2.5 py-1.5 text-sm outline-none focus:border-[var(--community-accent)]";
...
export function CommunityEditForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      {liveOnMap ? (
        <p className="rounded-md bg-[var(--community-accent-tint)] px-3 py-2 text-xs text-[var(--community-accent)]">
      ...
      <div className="flex gap-2 pt-1">
        <button
          type="submit"
          disabled={pending}
          className="rounded-lg bg-[var(--community-accent)] px-3 py-2 text-sm font-medium text-white disabled:opacity-60"
        >
